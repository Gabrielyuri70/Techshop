...
function toggleDeviceType() {
    ...
    // Limpa o campo de busca e oculta os resultados da busca anterior ao alternar o seletor
...
function searchApps() {
    ...
    // Oculta os campos de filtro manual para focar a interface no resultado da busca
    if (tvFields) tvFields.style.display = "none";
    if (mobileFields) mobileFields.style.display = "none";
